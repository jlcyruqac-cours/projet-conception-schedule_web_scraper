...
class Scraper:
    def __init__(self):
        ...
        self.list_courses = soup.find(id="liste_horaire")


    # Function to convert day/time to codes
    def dayTimeToCodes(self, day, begTime, endTime):
        switcher = {
            'lundi': '0',
            'mardi': '1',
            'mercredi': '2',
    ...
    def scrap(self):
        course_names = self.list_courses.find_all(class_="titrecours")
        list_horaire = []
        ...
        for course in course_names:
                    ...
                    if test == 0:
                        for index in indexes:
                            ...
                            if len(course.horaire) > 10:
                                ...
                                course.horaires.append(
                                    [course.local, self.dayTimeToCodes(course.beg_day, course.beg_time, course.end_time).split(' ')])
                                ...
                                course.horaires.append(
                                    [course.local, course.beg_day, course.beg_date, course.end_day, course.end_date])
            ...
            list_horaire.append(course.horaires)
